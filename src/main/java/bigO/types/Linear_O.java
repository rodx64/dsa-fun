...
public class Linear_O {
    ...
    private static String[] onlyNemo = {nemo};
    private static String[] everyone = {"dory", "bruce", "marlin", nemo, "gill", "bloat", "nigel", "squirt", "darla", "hank"};

    // BIG O Rule 1 -> WORST CASE it's what matters because, if nemo on last position, break doesn't matter in this case
    private static String[] everyoneWorstCase = {"dory", "bruce", "marlin", "gill", "bloat", "nigel", "squirt", "darla", "hank", nemo};
    private static String[] oceanPals = new String[10000000];
